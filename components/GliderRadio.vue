<template>
  <div class="radio-container" :style="{ '--total-radio': options.length }">
...
<style scoped>
.radio-container {
  --secondary-color-opacity: #ebca0f31;
  --total-radio: 3;
...
/* Dinámicamente generamos estas reglas hasta 10 opciones */
