<template>
    <div class="pin-container">
        ...
        <div class="pin-dots" :class="{ shake: isShaking }">
            <span v-for="index in pinLength" :key="index" class="pin-dot"
                :class="{ filled: index <= pin.length }"></span>
        </div>
...
// 👇 Detecta cambios en resetSignal para limpiar el PIN
watch(() => props.resetSignal, () => {
    clearPin();
});
</script>
